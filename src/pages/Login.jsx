...
import {ArrowRightIcon,BoxIcon,GitHubIcon,GoogleIcon,LockIcon,LogoIcon,MailIcon,
} from '../components/auth/SvgIcons';
    ...
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="hidden md:flex flex-col justify-center items-center p-12 bg-orange-500 text-white text-center">
        ...
        <div className="flex gap-6">
          <div className="bg-white/10 p-6 rounded-xl hover:bg-white/20 hover:scale-105 transition-transform">
